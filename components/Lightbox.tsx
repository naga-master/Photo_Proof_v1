    ...
    return (
        <form onSubmit={handleSubmit} className={`flex gap-2 ${isReply ? 'p-2 bg-gray-100 rounded-md' : 'p-4 border-t bg-gray-50'}`}>
            <input
                ...
                className="flex-1 border border-gray-300 rounded-md py-2 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-gray-900"
            />
            <button type="submit" className="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                Send
            </button>
            {isReply && onCancel && (
