                    ...
                    <div className="mt-4 space-y-4">
                        <div className="relative flex items-start">
                            <div className="flex items-center h-5">
                                <input id="aiTagging" name="aiTagging" type="checkbox" checked={uploadRules.aiTagging} onChange={(e) => handleRuleChange('aiTagging', e.target.checked)} className="focus:ring-gray-500 h-4 w-4 text-gray-600 border-gray-300 rounded" />
                            </div>
                         ...
                         <div className="relative flex items-start">
                            <div className="flex items-center h-5">
                                <input id="aiCulling" name="aiCulling" type="checkbox" checked={uploadRules.aiCulling} onChange={(e) => handleRuleChange('aiCulling', e.target.checked)} className="focus:ring-gray-500 h-4 w-4 text-gray-600 border-gray-300 rounded" />
                            </div>
                            <div className="ml-3 text-sm">
