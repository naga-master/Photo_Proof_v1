  ...
  return (
    <div className="w-full max-w-2xl text-center animate-slide-up">
      ...
      <div className="mt-8 flex flex-col sm:flex-row justify-center gap-6">
        <button
          onClick={() => setMode('new')}
          className="flex flex-col items-center justify-center gap-4 p-8 w-full sm:w-64 h-48 bg-white border-2 border-gray-300 rounded-lg hover:border-primary hover:bg-primary/5 transition-all transform hover:scale-105"
        >
