...
export const ShoppingCartIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c.51 0 .962-.344 1.087-.835l1.828-6.431A1.125 1.125 0 0018.332 6H6.136a1.125 1.125 0 00-1.087.835L3.38 8.625m7.5 5.625a3 3 0 11-6 0 3 3 0 016 0zm1.5 0a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);
...
export const CompareIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M5 6a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V6Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 10a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1h-8a1 1 0 0 1-1-1v-8Z" />
    </svg>
);
...
export const ChatBubbleIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 01-2.555-.332A.75.75 0 018.11 19.07l.46-1.533a.75.75 0 011.064-.223 8.25 8.25 0 0012.87-5.332A8.25 8.25 0 0021 12zM3 12a9 9 0 1018 0 9 9 0 00-18 0z" />
  </svg>
);
...
export const WrenchScrewdriverIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.664 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 004.474-4.474c-.048-.58-.122-1.163-.266-1.743m-1.5 0A4.496 4.496 0 0012 3a4.5 4.5 0 00-4.474 4.474c-.048.58-.122 1.163-.266 1.743m1.5 0l-.21.643m.643-.21c-.293.048-.587.122-.87.233m.87-.233l.643-.21m-1.086.444c.293-.048.587-.122.87-.233m-1.5 0l-1.086.444m1.086-.444l-.21.643m0 0l-1.086.444m0 0l.21.643m0 0l-1.086.444m0 0l.21.643m.87-.233l.643-.21" />
    </svg>
);
...
export const ClientsIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.51.056 1.02.083 1.53.083h1.17c.51 0 1.02-.027 1.53-.083m-3.06 0c.814-.083 1.628-.187 2.44-.334a9.09 9.09 0 004.26-2.816m-4.26 2.816c.322.146.64.283.968.403m-2.44-.334c.614-.093 1.228-.203 1.844-.334m-1.844.334a9.09 9.09 0 00-2.44 0m0 0a9.09 9.09 0 00-2.44 0m2.44 0A21.977 21.977 0 006 18c0 .59.02 1.17.058 1.74m3.188-2.921c.51-.056 1.02-.083 1.53-.083h1.17c.51 0 1.02.027 1.53.083m0 0c.814-.083 1.628-.187 2.44-.334a9.09 9.09 0 004.26-2.816m-4.26 2.816c.322.146.64.283.968.403m-4.812-3.348a21.977 21.977 0 01-3.188 0m3.188 0c.614-.093 1.228-.203 1.844-.334M12 12a4.5 4.5 0 014.5 4.5v.375m-9-.375V16.5A4.5 4.5 0 0112 12zm0-9a4.5 4.5 0 014.5 4.5v.375m-9-.375V7.5A4.5 4.5 0 0112 3zm0 9a4.5 4.5 0 00-4.5 4.5v.375m9-.375V16.5a4.5 4.5 0 00-4.5-4.5zm0-9a4.5 4.5 0 00-4.5 4.5v.375" />
    </svg>
);
export const InvoicesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
